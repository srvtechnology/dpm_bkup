        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="header">
                    <div class="">
                        <h2>
                            Property Occupancy Details Audit filter
                        </h2>
                    </div>
                </div>
                <div class="body">
            ...
            @if($activity->count())
                <div class="card">
                    <div class="header">
                        <h2>
                            Property Occupancy Details Audit Log
                        </h2>
                    </div>
                    <div class="row">
                                                ...
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Property Occupancy Details</h4>
