                ...
                <div class="custom-width" style="font-family: arial; font-size: 11px">
                    ...
                    <table class="font-weight-bold table-font-size">
                        ...
                        <tr>
                            ...
                            <td style="font-size: 12px;padding-bottom: 8px">{{$property->ward}}</td>
                        </tr>
                        <tr>
                            <td style="font-size: 12px;padding-bottom: 8px">CONSTITUENCY:</td>
                            <td style="font-size: 12px;padding-bottom: 8px">{{$property->constituency}}</td>
                        </tr>
                        <tr>
                            <td style="font-size: 12px;padding-bottom: 8px">DISTRICT:</td>
                            <td style="font-size: 12px;padding-bottom: 8px">{{$property->district}}</td>
                        </tr>
                        <tr>
                            <td style="font-size: 12px;padding-bottom: 8px">PROVINCE:</td>
                            <td style="font-size: 12px;padding-bottom: 8px">{{$property->province}}</td>
                        </tr>
                        <tr>
...
{{--                        </tr>--}}
                        <tr>
                            ...
                            <td style="font-size: 12px;padding-bottom: 8px">Le {{($payment->amountPaid())}}</td>
                        </tr>
                        <tr>
