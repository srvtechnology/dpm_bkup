...
class Property extends Model
{
    ...
    public function getAddress()
    {
        ...
        return "<strong>Name: </strong>" . $name . '<br><br><strong>Open location code: </strong>' . $this->newDigitalAddress() . '<br><br><strong>Assessment Amount: </strong> Le ' . number_format($this->assessment->property_rate_without_gst, 0, '', ',') . '<br><br><strong>Address: </strong>' . $this->street_number . ', ' . $this->street_name . ', ' . $this->ward . ', ' . $this->section . ', ' . $this->section . ', ' . $this->district . ', ' . $this->province . '<br><br><a target="_blank" href="https://www.google.com/maps/?q=' . $lat . ',' . $long . '">Go To Map</a> ';
    }
